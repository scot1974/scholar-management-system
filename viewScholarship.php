...
<body id='body-bg'>
	<div class='container-fluid' style='padding-top:10px;background-color:#fff;margin-top: 100px; margin-bottom: 20px; width: 1300px; height: 500px;'>
  ...
  { 
    ...
    $status=$retrive['status'];
      ...
      echo "<th><a href='paymentDetails.php'>Click Here</a><th>";
